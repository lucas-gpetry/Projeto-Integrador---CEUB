...
Essa análise leva em consideração 12.123 ocorrências associadas à Lei Maria da Penha. Os dados são referentes ao ano de 2025.
...
**O horário das ocorrências reforça esse padrão: há uma concentração expressiva nos períodos noturnos, especialmente entre 20h e 23h, o que é compatível com o momento de maior convívio doméstico entre vítima e agressor. Nessa mesma janela horária, observa-se a maior incidência de ocorrências associadas ao consumo de álcool, com pico às 21h — dado que converge com a análise por dia da semana e sugere que o agravamento noturno não é apenas circunstancial, mas frequentemente potencializado pelo uso de substâncias psicoativas — terminologia mais abrangente utilizada pela Organização Mundial da Saúde - OMS e literatura médica.**
...
**Nas ocorrências analisadas, observa-se que mais de 70% dos casos envolvem violência física ou patrimonial**

Nas ocorrências analisadas, mais de 70% dos casos envolvem violência física ou patrimonial. Esse dado, porém, deve ser interpretado com cautela: categorias como violência psicológica, moral e sexual tendem a ser subnotificadas nos registros policiais, uma vez que dificilmente motivam, por si sós, o acionamento da Polícia Militar. A menor representatividade dessas categorias nos dados reflete, portanto, uma limitação do canal de registro — não necessariamente sua menor ocorrência na realidade.
...
**Mais de 30% das ocorrências estão associadas a pelo menos um fator agravante, como consumo de álcool ou drogas, descumprimento de medida protetiva ou término recente de relacionamento. Desse total, os dois fatores mais recorrentes — consumo de álcool (≈ 12%) e descumprimento de medida protetiva (≈ 11%) — respondem juntos por cerca de 23% das ocorrências analisadas.[**
...
Este fator foi identificado por meio de processamento de linguagem natural (NLP), buscando termos como embriaguez, bebida, cerveja, entre outros, nos históricos das ocorrências. Cerca de 12% dos registros mencionam o consumo de álcool no contexto da agressão. Contudo, o contexto apresenta uma limitação importante: esse dado reflete o que foi registrado pelo policial no B.O., e não uma constatação clínica. Casos em que houve consumo mas não foi relatado não aparecem nesta análise, o que sugere que o percentual real pode ser superior.
